        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.UUIDField(
                        editable=False, unique=True, verbose_name="Public identifier"
                    ),
                ),
                (
                    "transfer_outcome",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("creditor-settlement", "Creditor-settlement"),
                            ("card-addition-refund", "Card-addition-refund"),
                        ],
                        max_length=50,
                    ),
                ),
                ...
                (
                    "recipient",
                    models.ForeignKey(
                        help_text="NULL means the recipient who received this transfer has been deleted on Halver. Check full paystack data for recipient details.",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="paystack_transfers_received",
                        to="financials.transferrecipient",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("participant_payment", "Participant_payment"),
                ...
                (
                    "card",
                    models.ForeignKey(
                        help_text="NULL means the card used for this transaction has been deleted on Halver. Check full paystack data for card details.",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="paystack_transactions",
                        to="financials.usercard",
                    ),
                ),
                (
                    "paying_user",
