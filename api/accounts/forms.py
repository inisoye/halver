...
class CaseInsensitiveUsernameFieldCreationForm(UserCreationForm):
    ...
    lowercased before they are saved. This is to disallow the existence
    of email address usernames which differ only in case. This is also
    redundant as it has been handled in the model.
    """
...
"""
Set the correct clean method on the class so that child classes
can override and call super()
"""
setattr(
...
class FriendlyPasswordResetForm(OldPasswordResetForm):
    ...
    error_messages["unknown"] = _(
        "This email address doesn't have an "
